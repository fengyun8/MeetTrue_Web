...
use PhpSms;
use Validator;
use App\Exceptions\SelfExceptions\LaravelSmsException;
...
class SmsManager
{
    ...
    protected static function storage()
    {
        ...
        if (!($store instanceof Storage)) {
            throw new LaravelSmsException("Failed to generator store, the class [$className] does not implement the interface [App\\Contracts\\Storage\\Storage].");
        }
